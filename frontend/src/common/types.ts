...
export const VRAMs: VRAMOptions[] = [
	"2GB",
	"4GB",
	"6GB",
	"8GB",
...
export const StorageTypes: StorageType[] = ["HDD", "SSD"];
...
export const AverageGraphicsPresets: AverageGraphicsPreset[] =
	["Low", "Medium", "High", "Ultra"];
export const UpscalingMethods: UpscalingMethod[] = [
	"Native",
	"FSR",
	"DLSS",
	"XeSS",
];
export const UpscalingQualitys: UpscalingQuality[] = [
	"Native",
	"DLAA",
	"Quality",
	"Balanced",
